...
<<<<<<< HEAD
        ...
        jCancelarBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/Buttons/CancelarBtn.png"))); // NOI18N
        jCancelarBtn.setBorder(null);
        jCancelarBtn.setBorderPainted(false);
        jCancelarBtn.setPreferredSize(new java.awt.Dimension(194, 51));
        jCancelarBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                jCancelarBtnMouseEntered(evt);
            }
...
<<<<<<< HEAD
    ...
    private void jLEntrarBtnMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLEntrarBtnMouseEntered
        jLEntrarBtn.setIcon(new ImageIcon(getClass().getResource("/Imagens/Buttons/Entrar_FocusBtn.png")));
    }//GEN-LAST:event_jLEntrarBtnMouseEntered

    private void jLEntrarBtnMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLEntrarBtnMouseExited
        jLEntrarBtn.setIcon(new ImageIcon(getClass().getResource("/Imagens/Buttons/EntrarBtn.png")));
    }//GEN-LAST:event_jLEntrarBtnMouseExited

    private void jCancelarBtnMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jCancelarBtnMouseEntered
        jCancelarBtn.setIcon(new ImageIcon(getClass().getResource("/Imagens/Buttons/Cancelar_FocusBtn.png")));
    }//GEN-LAST:event_jCancelarBtnMouseEntered

    private void jCancelarBtnMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jCancelarBtnMouseExited
        jCancelarBtn.setIcon(new ImageIcon(getClass().getResource("/Imagens/Buttons/CancelarBtn.png")));
    }//GEN-LAST:event_jCancelarBtnMouseExited
